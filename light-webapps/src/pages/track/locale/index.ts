const i18n = {
  'en-US': {
    'statTrack.breadcrumb.title':'Debug Mode',
    'statTrack.label1':'Debug Mode:',
    'statTrack.label2':'Current Group:',
    'statTrack.label3':'Statistic:',
    'statTrack.fresh.label':'Auto Refresh',
    'statTrack.list.empty.message':'Please wait, current statistics group messages are being captured!',
    'statTrack.notify.turnedON':'Debug mode is turned on, debugging period:[%s - %s].',
    'statTrack.notify.turnedOFF':'Debug mode is turned off.',
  ...
  'zh-CN': {
    ...
    'statTrack.label1':'调试模式：',
    'statTrack.label2':'当前统计组：',
    'statTrack.label3':'统计项：',
    'statTrack.fresh.label':'自动刷新',
    'statTrack.list.empty.message':'请等待，正在抓取当前统计组消息!',
    'statTrack.notify.turnedON':'调试模式已打开，调试周期：[%s - %s]。',
    'statTrack.notify.turnedOFF':'调试模式已关闭。',
