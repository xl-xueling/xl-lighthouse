const i18n = {
  'en-US': {
    ...
    'statList.table.operations.binded':'Binded',
    ...
    'statList.label.group':'Group',
    'statList.label.timeparam':'TimeParam',
    'statList.label.state':'State',
    'statList.label.createTime':'CreateTime',
  ...
  'zh-CN': {
    ...
    'statList.table.operations.binded':'已绑定',
    ...
    'statList.label.createTime':'创建时间',
