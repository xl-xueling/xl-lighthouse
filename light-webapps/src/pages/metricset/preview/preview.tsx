...
export default function MetricPreviewPanel ({id,PRO_ViewBindTab = null}) {
    ...
    return (
        <MetricSetPreviewContext.Provider value={{metricSetInfo, setMetricSetInfo, reloadTime, setReloadTime,PRO_ViewBindTab}}>
            <>
                {
