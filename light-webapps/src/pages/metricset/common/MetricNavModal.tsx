    ...
    return (
        <Modal
            ...
            <Space style={{justifyContent: 'center', padding:'0px',marginTop:'0px',width: '100%'}}>
                {staredMetricInfo.length > 0 && <Pagination showTotal={true} total={staredMetricInfo.length} pageSize={pagination.pageSize} onChange={handleChangePage} current={pagination.current}/>}
            </Space>
        </Modal>
    );
}