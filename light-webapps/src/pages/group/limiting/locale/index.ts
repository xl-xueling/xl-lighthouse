const i18n = {
    'en-US': {
        ...
        'limitingConfig.form.label.strategy':'Strategy',
        'limitingConfig.form.label.currentValue':'Current Value',
    ...
    'zh-CN': {
        ...
        'limitingConfig.form.label.strategy':'限流策略',
        'limitingConfig.form.label.currentValue':'当前值',
