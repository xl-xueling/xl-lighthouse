const i18n = {
  'en-US': {
    ...
    'workplace.label.projectCount':'Number of Projects',
    'workplace.label.ytdStatCount':'YTD Created Size',
    'workplace.label.statCount':'Number of Statistics',
    'workplace.label.ytdMetricCount':'YTD Created Size',
    'workplace.label.metricCount':'Number of MetricSets',
    'workplace.label.userCount':'Number of Users',
  ...
  'zh-CN': {
    ...
    'workplace.label.projectCount':'工程数量',
    'workplace.label.ytdStatCount':'昨日创建量',
    'workplace.label.statCount':'统计项数量',
    'workplace.label.ytdMetricCount':'昨日创建量',
    'workplace.label.metricCount':'指标集数量',
