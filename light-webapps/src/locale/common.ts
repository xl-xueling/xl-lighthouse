const vi18n = {
    'en-US': {
        ...
        'basic.orderType.description.callerProjectAccessExtension':'APICaller Project Access Extension',
        'basic.orderType.description.callerStatAccessExtension':'APICaller Statistic Access Extension',
        'basic.orderType.description.callerViewAccessExtension':'APICaller View Access Extension',
        ...
        'basic.order.description.callerProjectAccessExtension':'APICaller[%s] Project[%s] Access Extension',
        'basic.order.description.callerStatAccessExtension':'APICaller[%s] Stat[%s] Access Extension',
        'basic.order.description.callerViewAccessExtension':'APICaller[%s] View[%s] Access Extension',
