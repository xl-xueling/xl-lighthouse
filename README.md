...
-  [开源版本（最新：v2.2.4）](https://dtstep.com/zh/versions/02.html)
-  [商业版本（最新：v2.2.4-pro.1）](https://dtstep.com/zh/commercial/01.html)
...
- 企业、机构内部使用或个人学习使用XL-LightHouse源程序不受任何限制，但不可删除程序中的Logo标识、版权声明等信息。
...
6、商业版本是在开源版本的基础上额外新增功能，开源版本所有已提供的功能不会有任何使用层面的限制（比如不会限制数据量、集群规模、统计指标数量等等）。
