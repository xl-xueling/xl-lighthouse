...
+  可以短时间内快速实现庞大量级数据指标，而这是Flink、Spark、ClickHouse、Doris、Prometheus、时序数据库等之类技术所远不能比拟的，可以支撑支撑百万量级数据指标，低成本触达每一个细微的产品模块，帮助企业搭建遍布全身的数据化运营体系；
...
+ 可以面向物联网、工业互联网、车联网、智能制造、现代农业、智能交通、智能工厂、智能家居、机器人、无人机等众多场景实现各类科技设备相关数据指标统计和运行状态监控；
