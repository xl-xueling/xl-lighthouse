...
有的朋友可能会质疑XL-LightHouse，一个连留存、月活都不能实现，连join都不能支持的产品，它在业内究竟处于一个什么样的位置？
...
通用型流式统计更像是“汽车”，或许它并不完美，但是它的核心优势在于：使用便捷，成本极低。企业的数据指标需求越多，通用型流式统计的优势就越明显。它不能取代OLAP，但是它可以急剧的缩减OLAP集群的规模。
