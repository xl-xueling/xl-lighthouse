...
<head>
  ...
  <title class="i18n">i18n(ldp_i18n_favorite_stat_1000)</title>
  <@baseFrame.top />
</head>
      ...
      <div class="content-wrapper" style="padding-top:30px;">
        <section class="content">
          <div class="error-page">
            <div class="">
              <h5>&nbsp;&nbsp;
                <samp class="i18n" i18n_code="ldp_i18n_favorite_stat_1001"></samp>
      ...
      <div class="content-wrapper">
        <section class="content-header">
          <h1 style="font-size: 14px;">
            <samp class="i18n" i18n_code="ldp_i18n_favorite_stat_1002"></samp>
          </h1>
          <ol class="breadcrumb">
            <li><a href="/index.shtml"><i class="fa fa-dashboard"></i>Home</a></li>
            <li class="active"><samp class="i18n" i18n_code="ldp_i18n_favorite_stat_1002"></samp></li>
          </ol>
        </section>
        <section class="content">
          <div class="row">
            <div class="col-md-3" style="width: 20%;padding-left:10px;padding-right: 8px;">
              <a href="#" class="btn btn-primary btn-block margin-bottom">
                <samp class="i18n" i18n_code="ldp_i18n_favorite_stat_1003"></samp>
              </a>
...
<@baseFrame.tail />
<script src="/static/js/group/group_operator.js" charset="utf-8"></script>
...
<SCRIPT type="text/javascript">
  function _PageLoadCallBack(){
    let setting = {
      ...
      callback:{
        onClick:FAVORITES_OPERATOR.itemClick
      }
    };
