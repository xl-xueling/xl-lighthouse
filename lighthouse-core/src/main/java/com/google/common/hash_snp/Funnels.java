...
public final class Funnels {
  ...
  private enum ByteArrayFunnel implements Funnel<byte[]> {
    ...
    public void funnel(byte[] from, com.google.common.hash_snp.PrimitiveSink into) {
      into.putBytes(from);
    }
  ...
  private enum UnencodedCharsFunnel implements Funnel<CharSequence> {
    ...
    public void funnel(CharSequence from, com.google.common.hash_snp.PrimitiveSink into) {
  ...
  private enum IntegerFunnel implements Funnel<Integer> {
    ...
    public void funnel(Integer from, com.google.common.hash_snp.PrimitiveSink into) {
      into.putInt(from);
    }
  ...
  private static class SequentialFunnel<E> implements Funnel<Iterable<? extends E>>, Serializable {
    ...
    public void funnel(Iterable<? extends E> from, com.google.common.hash_snp.PrimitiveSink into) {
      for (E e : from) {
  ...
  private enum LongFunnel implements Funnel<Long> {
    ...
    public void funnel(Long from, com.google.common.hash_snp.PrimitiveSink into) {
      into.putLong(from);
    }
   ...
   * @since 13.0
   */
  public static OutputStream asOutputStream(com.google.common.hash_snp.PrimitiveSink sink) {
    return new SinkAsStream(sink);
  }
  
  private static class SinkAsStream extends OutputStream {
    final com.google.common.hash_snp.PrimitiveSink sink;
    SinkAsStream(com.google.common.hash_snp.PrimitiveSink sink) {
