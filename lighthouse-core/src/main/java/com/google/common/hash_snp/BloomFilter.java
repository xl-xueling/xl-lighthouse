...
public final class BloomFilter<T> implements Predicate<T>, Serializable {
  ...
  interface Strategy extends Serializable {
    ...
    <T> boolean mightContain(
            T object, Funnel<? super T> funnel, int numHashFunctions, BloomFilterStrategies.BitArray bits);
   ...
   */
  private BloomFilter(BloomFilterStrategies.BitArray bits, int numHashFunctions, Funnel<T> funnel,
      Strategy strategy) {
  ...
  /**
   * @deprecated Provided only to satisfy the {@link com.google.common.base.Predicate} interface; use {@link #mightContain}
   *     instead.
   */
  @Deprecated
  @Override
  ...
  public static <T> BloomFilter<T> create(
    ...
    try {
      return new BloomFilter<T>(new BloomFilterStrategies.BitArray(numBits), numHashFunctions, funnel,
