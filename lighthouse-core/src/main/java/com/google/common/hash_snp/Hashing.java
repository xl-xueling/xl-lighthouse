...
/**
 * Static methods to obtain {@link com.google.common.hash_snp.HashFunction} instances, and other static hashing-related
 * utilities.
 *
...
public final class Hashing {
   ...
   * for {@code minimumBits}, will return identically-behaving {@link com.google.common.hash_snp.HashFunction} instances.
   *
   * @param minimumBits a positive integer (can be arbitrarily large)
   * @return a hash function, described above, that produces hash codes of length {@code
   *     minimumBits} or greater
   */
  public static com.google.common.hash_snp.HashFunction goodFastHash(int minimumBits) {
    ...
    com.google.common.hash_snp.HashFunction[] hashFunctions = new com.google.common.hash_snp.HashFunction[hashFunctionsNeeded];
   ...
   */
  public static com.google.common.hash_snp.HashFunction murmur3_32(int seed) {
   ...
   * <p>The exact C++ equivalent is the MurmurHash3_x86_32 function (Murmur3A).
   */
  public static com.google.common.hash_snp.HashFunction murmur3_32() {
    return Murmur3_32Holder.MURMUR3_32;
  }

  private static class Murmur3_32Holder {
    static final com.google.common.hash_snp.HashFunction MURMUR3_32 = new Murmur3_32HashFunction(0);

    /** Returned by {@link #goodFastHash} when {@code minimumBits <= 32}. */
    static final com.google.common.hash_snp.HashFunction GOOD_FAST_HASH_FUNCTION_32 = murmur3_32(GOOD_FAST_HASH_SEED);
  }
   ...
   */
  public static com.google.common.hash_snp.HashFunction murmur3_128(int seed) {
    return new com.google.common.hash_snp.Murmur3_128HashFunction(seed);
  }
   ...
   * <p>The exact C++ equivalent is the MurmurHash3_x64_128 function (Murmur3F).
   */
  public static com.google.common.hash_snp.HashFunction murmur3_128() {
    return Murmur3_128Holder.MURMUR3_128;
  }

  private static class Murmur3_128Holder {
    static final com.google.common.hash_snp.HashFunction MURMUR3_128 = new com.google.common.hash_snp.Murmur3_128HashFunction(0);

    /** Returned by {@link #goodFastHash} when {@code 32 < minimumBits <= 128}. */
    static final com.google.common.hash_snp.HashFunction GOOD_FAST_HASH_FUNCTION_128 = murmur3_128(GOOD_FAST_HASH_SEED);
  }
   ...
   * @since 15.0
   */
  public static com.google.common.hash_snp.HashFunction sipHash24() {
    return SipHash24Holder.SIP_HASH_24;
  }

  private static class SipHash24Holder {
    static final com.google.common.hash_snp.HashFunction SIP_HASH_24 =
   ...
   * @since 15.0
   */
  public static com.google.common.hash_snp.HashFunction sipHash24(long k0, long k1) {
   ...
   * the MD5 {@link java.security.MessageDigest}.
   */
  public static com.google.common.hash_snp.HashFunction md5() {
    return Md5Holder.MD5;
  }

  private static class Md5Holder {
    static final com.google.common.hash_snp.HashFunction MD5 = new com.google.common.hash_snp.MessageDigestHashFunction("MD5", "Hashing.md5()");
  }

  /**
   * Returns a hash function implementing the SHA-1 algorithm (160 hash bits) by delegating to the
   * SHA-1 {@link java.security.MessageDigest}.
   */
  public static com.google.common.hash_snp.HashFunction sha1() {
    return Sha1Holder.SHA_1;
  }

  private static class Sha1Holder {
    static final com.google.common.hash_snp.HashFunction SHA_1 =
        new com.google.common.hash_snp.MessageDigestHashFunction("SHA-1", "Hashing.sha1()");
  }

  /**
   * Returns a hash function implementing the SHA-256 algorithm (256 hash bits) by delegating to
   * the SHA-256 {@link java.security.MessageDigest}.
   */
  public static com.google.common.hash_snp.HashFunction sha256() {
    return Sha256Holder.SHA_256;
  }

  private static class Sha256Holder {
    static final com.google.common.hash_snp.HashFunction SHA_256 =
        new com.google.common.hash_snp.MessageDigestHashFunction("SHA-256", "Hashing.sha256()");
  }

  /**
   * Returns a hash function implementing the SHA-512 algorithm (512 hash bits) by delegating to the
   * SHA-512 {@link java.security.MessageDigest}.
   */
  public static com.google.common.hash_snp.HashFunction sha512() {
    return Sha512Holder.SHA_512;
  }

  private static class Sha512Holder {
    static final com.google.common.hash_snp.HashFunction SHA_512 =
        new com.google.common.hash_snp.MessageDigestHashFunction("SHA-512", "Hashing.sha512()");
  }
   ...
   * {@code HashCode} produced by this function, use {@link com.google.common.hash_snp.HashCode#padToLong()}.
   *
   * @since 14.0
   */
  public static com.google.common.hash_snp.HashFunction crc32() {
    return Crc32Holder.CRC_32;
  }

  private static class Crc32Holder {
    static final com.google.common.hash_snp.HashFunction CRC_32 =
   ...
   * @since 14.0
   */
  public static com.google.common.hash_snp.HashFunction adler32() {
    return Adler32Holder.ADLER_32;
  }

  private static class Adler32Holder {
    static final com.google.common.hash_snp.HashFunction ADLER_32 =
        checksumHashFunction(ChecksumType.ADLER_32, "Hashing.adler32()");
  }

  private static com.google.common.hash_snp.HashFunction checksumHashFunction(ChecksumType type, String toString) {
   ...
   */
  public static int consistentHash(com.google.common.hash_snp.HashCode hashCode, int buckets) {
   ...
   */
  public static com.google.common.hash_snp.HashCode combineOrdered(Iterable<com.google.common.hash_snp.HashCode> hashCodes) {
    Iterator<com.google.common.hash_snp.HashCode> iterator = hashCodes.iterator();
    checkArgument(iterator.hasNext(), "Must be at least 1 hash code to combine.");
    int bits = iterator.next().bits();
    byte[] resultBytes = new byte[bits / 8];
    for (com.google.common.hash_snp.HashCode hashCode : hashCodes) {
    ...
    return com.google.common.hash_snp.HashCode.fromBytesNoCopy(resultBytes);
  }
   ...
   *     do not all have the same bit length
   */
  public static com.google.common.hash_snp.HashCode combineUnordered(Iterable<com.google.common.hash_snp.HashCode> hashCodes) {
    Iterator<com.google.common.hash_snp.HashCode> iterator = hashCodes.iterator();
    checkArgument(iterator.hasNext(), "Must be at least 1 hash code to combine.");
  ...
  @VisibleForTesting
  static final class ConcatenatedHashFunction extends com.google.common.hash_snp.AbstractCompositeHashFunction {
    private final int bits;

    ConcatenatedHashFunction(com.google.common.hash_snp.HashFunction... functions) {
      super(functions);
      int bitSum = 0;
      for (com.google.common.hash_snp.HashFunction function : functions) {
    ...
    @Override
    com.google.common.hash_snp.HashCode makeHash(Hasher[] hashers) {
      byte[] bytes = new byte[bits / 8];
      int i = 0;
      for (Hasher hasher : hashers) {
        com.google.common.hash_snp.HashCode newHash = hasher.hash();
        i += newHash.writeBytesTo(bytes, i, newHash.bits() / 8);
      }
      return com.google.common.hash_snp.HashCode.fromBytesNoCopy(bytes);
    }
