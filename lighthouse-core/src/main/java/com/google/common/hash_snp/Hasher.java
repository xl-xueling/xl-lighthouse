 ...
 * The resulting {@link com.google.common.hash_snp.HashCode} is dependent only on the bytes inserted, and the order in which
...
public interface Hasher extends PrimitiveSink {
   ...
   */
  com.google.common.hash_snp.HashCode hash();
}
