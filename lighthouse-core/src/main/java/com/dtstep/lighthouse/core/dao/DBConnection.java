...
public class DBConnection {
    ...
    private boolean transactionSwitch = false;
    ...
    public DBConnection(Connection connection,boolean autoClose){
        this.connection = connection;
        this.transactionSwitch = autoClose;
    }
    ...
    public void setTransactionSwitch(boolean transactionSwitch) {
