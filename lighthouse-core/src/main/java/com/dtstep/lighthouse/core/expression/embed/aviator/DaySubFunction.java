...
public class DaySubFunction extends AbstractFunction{

    private static final long serialVersionUID = 2652951214819640676L;
    ...
    public AviatorObject call(Map<String,Object> env, AviatorObject arg1, AviatorObject arg2){
        ...
        return AviatorLong.valueOf(EmbedFunction.day_sub(Long.parseLong(a), Integer.parseInt(b)));
    }
