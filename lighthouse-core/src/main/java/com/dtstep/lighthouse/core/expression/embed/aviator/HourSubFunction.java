...
public class HourSubFunction extends AbstractFunction{

    private static final long serialVersionUID = 4930239750202845215L;
    ...
    public AviatorObject call(Map<String,Object> env, AviatorObject arg1, AviatorObject arg2){
        ...
        return AviatorLong.valueOf(EmbedFunction.hour_sub(Long.parseLong(a), Integer.parseInt(b)));
    }
