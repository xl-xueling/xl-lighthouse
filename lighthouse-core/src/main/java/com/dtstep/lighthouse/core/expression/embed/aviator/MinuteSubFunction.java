...
public class MinuteSubFunction extends AbstractFunction{

    private static final long serialVersionUID = -3371710160656238458L;
    ...
    public AviatorObject call(Map<String,Object> env, AviatorObject arg1, AviatorObject arg2){
        ...
        return AviatorLong.valueOf(EmbedFunction.minute_sub(Long.parseLong(a), Integer.parseInt(b)));
    }
