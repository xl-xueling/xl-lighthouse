...
public class DateParseFunction extends AbstractFunction{
    ...
    private static final long serialVersionUID = -1795623791748918224L;

    public AviatorObject call(Map<String,Object> env, AviatorObject arg1, AviatorObject arg2){
        String a = FunctionUtils.getStringValue(arg1, env);
        ...
        return  AviatorLong.valueOf(EmbedFunction.parse_date(a, b));
    }
