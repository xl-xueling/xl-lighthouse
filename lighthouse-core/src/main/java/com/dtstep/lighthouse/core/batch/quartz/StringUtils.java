...
public abstract class StringUtils {
	...
	/**
	 * Parse the given {@code String} value into a {@link java.util.Locale}, accepting
	 * the {@link java.util.Locale#toString} format as well as BCP 47 language tags.
	 * @param localeValue the locale value: following either {@code Locale's}
	 * {@code toString()} format ("en", "en_UK", etc), also accepting spaces as
	 * separators (as an alternative to underscores), or BCP 47 (e.g. "en-UK")
	 * as specified by {@link java.util.Locale#forLanguageTag} on Java 7+
	...
	/**
	 * Parse the given {@code String} representation into a {@link java.util.Locale}.
	 * <p>For many parsing scenarios, this is an inverse operation of
	 * {@link java.util.Locale#toString Locale's toString}, in a lenient sense.
	 ...
	 * @deprecated as of 5.0.4, in favor of {@link java.util.Locale#toLanguageTag()}
	 */
	@Deprecated
	 ...
	 * @param timeZoneString the time zone {@code String}, following {@link java.util.TimeZone#getTimeZone(String)}
	...
	/**
	 * Copy the given {@link java.util.Collection} into a {@code String} array.
	...
	/**
	 * Copy the given {@link java.util.Enumeration} into a {@code String} array.
	 ...
	 * @deprecated as of 4.3.15, in favor of manual merging via {@link java.util.LinkedHashSet}
