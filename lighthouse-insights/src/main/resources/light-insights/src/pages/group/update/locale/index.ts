const i18n = {
  'en-US': {
    ...
    'groupUpdate.form.validate.columnName.notEmpty':'ColumnName cannot be empty!',
    'groupUpdate.form.validate.columnName.length.failed':'ColumnName[%s] length should be between 3-15 chars!',
    'groupUpdate.form.validate.columnName.failed':'Column name[%s] verification failed!',
    'groupUpdate.form.validate.desc.notEmpty.errorMsg':'Description cannot be empty!',
