const i18n = {
  'en-US': {
    ...
    'security.form.password.validate.errMsg': 'Password verification failed!',
  ...
  'zh-CN': {
    ...
    'security.form.password.validate.errMsg': '密码校验失败！',
    'security.form.confirm.password.errMsg': '确认密码不能为空！',
